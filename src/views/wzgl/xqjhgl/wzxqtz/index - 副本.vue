...
<template>
  <div class="formCustomization">
    ...
    <!-- 变更详情 -->
    <component v-if="comVisibleDetail" :is="comNameDetail" :dialogRowData="dialogRowData" @closeVisibleDetail="closeVisibleDetail"></component>
  </div>
</template>
...
import {listGybg,deleteGybg,exportEquiSbbg} from "./api/index";
import {
    getSysDictData
  ...
  methods: {
    ...
    getTableData() {
      listGybg({
          ...
          dept:this.bgsjdw&&this.bgsjdw.join(),
